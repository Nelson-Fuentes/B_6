...
public class ProductosPendientes extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    ImageView imagen;
    TextView imagen2;
    int i=0;
    String [] a={"2 Zapatos Azules L ","$4 Zapatos Blanco y Rojo M"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_productos_pendientes);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        imagen =(ImageView)findViewById(R.id.imageView5) ;
        imagen2 =(TextView)findViewById(R.id.textView16) ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.productos_pendientes, menu);
        return true;
    }
    ...
    public void next (View view){
        ...
        i= i%2;
        if (i == 1) {
            imagen.setImageResource(R.drawable.shoe1);

        } else{
            imagen.setImageResource(R.drawable.shoe5);
        }
